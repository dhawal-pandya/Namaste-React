...
const ResMenu = () => {
  ...
  return (
    <div className='flex flex-col text-white min-h-screen text-center text-white flex flex-col align-middle p-7 h-screen*0.75 m-0 font-sans bg-gradient-to-b from-black to-zinc-800'>
      <div
